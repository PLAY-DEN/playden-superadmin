                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                options={managers}
                                value={managers.find((opt: any) => opt.value === formData.manager_id)}
                                onChange={(selected: any) => handleSelectChange("manager_id", selected)}
                            />
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                selectClassName="py-1 rounded-full border-[0.4px] border-primary"
                                options={owners}
                                value={owners.find((opt: any) => opt.value === formData.owner_id)}
                                onChange={(selected: any) => handleSelectChange("owner_id", selected)}
                            />
                        ...
                        <div>
                            ...
                            <Select
                                ...
                                selectClassName="py-1 rounded-full border-[0.4px] border-primary"
                                options={categories}
                                value={categories.find((opt: any) => opt.value === formData.category_id)}
                                onChange={(selected: any) => handleSelectChange("category_id", selected)}
                            />
                            {errors.category_id && (
