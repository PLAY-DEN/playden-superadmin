...
const MyRoutes = () => (
  <Routes>
    ...
    <Route element={<BaseLayout />}>
      ...
      <Route path="/pitch-listing" element={<ProtectedRoute><PitchListing /></ProtectedRoute>} />
      <Route path="/pitch-listing/:pitchId" element={<ProtectedRoute><PitchDetails /></ProtectedRoute>} />
      <Route path="/add-new-pitch" element={<ProtectedRoute><AddNewPitch /></ProtectedRoute>} />
      <Route path="/booking-management" element={<ProtectedRoute><BookingManagement /></ProtectedRoute>} />
      <Route path="/booking-management/:id" element={<ProtectedRoute><BookingDetails /></ProtectedRoute>} />
      <Route path="/cancellation-management" element={<ProtectedRoute><CancellationManagement /></ProtectedRoute>} />
      <Route path="/cancellation-details/:id" element={<ProtectedRoute><CancellationDetails /></ProtectedRoute>} />
      <Route path="/play-point" element={<ProtectedRoute><PlaypointUsage /></ProtectedRoute>} />
      <Route path="/finances" element={<ProtectedRoute><Financials /></ProtectedRoute>} />
      <Route path="/user-management" element={<ProtectedRoute><UserManagement /></ProtectedRoute>} />
      <Route path="/user-management/User-details/:id" element={<ProtectedRoute><UserDetails /></ProtectedRoute>} />
      <Route path="/pitch-admin-management" element={<ProtectedRoute><PitchAdminManagement /></ProtectedRoute>} />
